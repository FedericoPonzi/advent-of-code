...
defmodule Day${DAY}Test do
  ...
  test "part 1-example" do
    assert Aoc2022.Day${DAY}.solve("assets/day${DAY}_example.txt") == 
  end
  ...
  test "part 2-example" do
    #assert Aoc2022.Day${DAY}.solve2("assets/day${DAY}_example.txt") == 
  end
...
echo "mix test test/day_${DAY}_test.exs"